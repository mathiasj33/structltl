...
dnf = load_df("runs/WarehouseEnv/struct_ltl/main/eval_results_checkpoints.csv")
flat = load_df("runs/WarehouseEnv/tokenized_ltl/main/eval_results_checkpoints.csv")
gnn = load_df("runs/WarehouseEnv/gcn_ltl/main/eval_results_checkpoints.csv")
dnf["Method"] = "Hierarchical"
flat["Method"] = "Flat"
gnn["Method"] = "GNN"
warehouse_df = pd.concat([dnf, flat, gnn], ignore_index=True)
...
desired_order = ["Hierarchical", "Flat", "GNN"]
...
plt.savefig("dnf_curves.pdf", bbox_inches="tight", dpi=300)
plt.show()
